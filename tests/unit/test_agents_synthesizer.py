...
class TestSynthesizerAgent:
    ...
    def mock_settings(self):
        ...
        with patch(
            "ai_deep_research_assistant.agents.synthesizer.get_settings"
            ...
            ResearchOutput(
                findings=[
                    ...
                    ResearchFinding(
                        ...
                        evidence_urls=["https://science.org/quantum-optimization-2024"],
                        evidence_titles=["Science: Quantum Optimization Advances"],
                        evidence_snippets=[
                ...
                sources_searched=8,
                search_queries_used=[
                    "quantum computing academic 2024",
                    "quantum algorithms peer-reviewed",
                ],
            ...
            ResearchOutput(
                findings=[
                    ...
                    ResearchFinding(
                        ...
                        evidence_titles=["Bloomberg: Google's Quantum Breakthrough"],
                        evidence_snippets=[
            ...
            ResearchOutput(
                findings=[
                    ResearchFinding(
                        ...
                        evidence_titles=["Market Research: Quantum Computing Growth"],
                        evidence_snippets=[
    ...
    async def test_synthesize_research_comprehensive(
        self, sample_research_results, sample_research_plan, mock_settings
    ):
...
The quantum computing market reflects this momentum, with projections indicating growth to $125 billion by 2030. Key areas of advancement include error correction methods, optimization algorithms, and hardware scaling, positioning quantum computing as a transformative technology for the next decade.""",
    ...
    async def test_synthesize_single_agent_research(
        self, sample_research_plan, mock_settings
    ):
        ...
        with patch.object(synthesizer_agent, "run") as mock_run:
            ...
            mock_result.output = SynthesisOutput(
                ...
                follow_up_questions=[
                    "Would additional news or general research be helpful?"
                ],
    ...
    async def test_synthesize_conflicting_findings(
        self, sample_research_plan, mock_settings
    ):
        ...
        with patch.object(synthesizer_agent, "run") as mock_run:
            ...
            mock_result.output = SynthesisOutput(
                ...
                source_urls=[
                    "https://optimistic-source.com",
                    "https://conservative-academic.edu",
                ],
                source_titles=[
                    "Optimistic Quantum Timeline",
                    "Conservative Quantum Assessment",
                ],
            ...
            assert any(
                "conflicting" in limitation.lower()
                for limitation in synthesis.limitations
            )

    async def test_synthesize_empty_research_results(
        self, sample_research_plan, mock_settings
    ):
    ...
    async def test_synthesize_research_error_handling(
        self, sample_research_results, sample_research_plan, mock_settings
    ):
    ...
    @pytest.mark.parametrize(
        "agent_count,expected_confidence",
        [
    ...
    async def test_confidence_based_on_agent_diversity(
        self, agent_count, expected_confidence, sample_research_plan, mock_settings
    ):
        """Test that confidence increases with agent diversity."""
        # Create results from different numbers of agents
        agent_types = ["academic_research", "news_research", "general_research"][
            :agent_count
        ]
